...
cp -av --preserve=links "/usr/lib/i386-linux-gnu/"libsfml*[!d].so.* "$DESTLIBPATH"
cp -av --preserve=links "/usr/lib/i386-linux-gnu/"libfreetype*.so.* "$DESTLIBPATH"
cp -av --preserve=links "/usr/lib/i386-linux-gnu/"libjpeg*.so.* "$DESTLIBPATH"
cp -av --preserve=links "/usr/lib/i386-linux-gnu/"liblua*.so.* "$DESTLIBPATH"
cp -av --preserve=links "/usr/lib/i386-linux-gnu/"libGLEW*.so.* "$DESTLIBPATH"
cp -av --preserve=links "/usr/lib/i386-linux-gnu/"libopenal*.so.* "$DESTLIBPATH"
cp -av --preserve=links "/usr/lib/i386-linux-gnu/"libstdc++*.so.* "$DESTLIBPATH"
