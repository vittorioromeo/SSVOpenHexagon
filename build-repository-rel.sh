...
cp -av "/usr/local/lib/"libsndfile*.so* "$DESTLIBPATH"
cp -av "/usr/local/lib/"libFLAC*.so* "$DESTLIBPATH"
cp -av "/usr/local/lib/"libogg.so* "$DESTLIBPATH"
cp -av "/usr/local/lib/"libvorbis*.so* "$DESTLIBPATH"
...
cp -av "/usr/lib/"libsndfile*.so* "$DESTLIBPATH"
cp -av "/usr/lib/"libFLAC*.so* "$DESTLIBPATH"
cp -av "/usr/lib/"libogg.so* "$DESTLIBPATH"
cp -av "/usr/lib/"libvorbis*.so* "$DESTLIBPATH"
...
cp -av "/usr/lib/i386-linux-gnu/"libsndfile*.so* "$DESTLIBPATH"
cp -av "/usr/lib/i386-linux-gnu/"libFLAC*.so* "$DESTLIBPATH"
cp -av "/usr/lib/i386-linux-gnu/"libogg.so* "$DESTLIBPATH"
cp -av "/usr/lib/i386-linux-gnu/"libvorbis*.so* "$DESTLIBPATH"
