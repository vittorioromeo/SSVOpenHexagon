...
void HexagonGame::initLua()
{
    ...
    lua.writeVariable("u_getPlayerPosition", [=] { return player.getPlayerPosition(); });
    lua.writeVariable("u_setPlayerPosition", [=] (float newPos) {player.setPlayerPosition(newPos); });
