...
PCG_DEFINE_CONSTANT(uint16_t, default, multiplier, 12'829U)
PCG_DEFINE_CONSTANT(uint16_t, default, increment, 47'989U)

PCG_DEFINE_CONSTANT(uint32_t, default, multiplier, 747'796'405U)
PCG_DEFINE_CONSTANT(uint32_t, default, increment, 2'891'336'453U)

PCG_DEFINE_CONSTANT(uint64_t, default, multiplier, 6'364'136'223'846'793'005ULL)
PCG_DEFINE_CONSTANT(uint64_t, default, increment, 1'442'695'040'888'963'407ULL)

PCG_DEFINE_CONSTANT(pcg128_t, default, multiplier, PCG_128BIT_CONSTANT(2'549'297'995'355'413'924ULL, 4'865'540'595'714'422'341ULL))
PCG_DEFINE_CONSTANT(pcg128_t, default, increment, PCG_128BIT_CONSTANT(6'364'136'223'846'793'005ULL, 1'442'695'040'888'963'407ULL))
...
public:
    ...
    engine(itype state = itype(0xca'fe'f0'0d'd1'5e'a5'e5ULL)) :
...
{
    static_assert(std::is_same<stream_mixin_lhs, stream_mixin_rhs>{} &&
...
PCG_DEFINE_CONSTANT(uint16_t, mcg, multiplier, 62'169U)
PCG_DEFINE_CONSTANT(uint16_t, mcg, unmultiplier, 28'009U)

PCG_DEFINE_CONSTANT(uint32_t, mcg, multiplier, 277'803'737U)
PCG_DEFINE_CONSTANT(uint32_t, mcg, unmultiplier, 2'897'767'785U)

PCG_DEFINE_CONSTANT(uint64_t, mcg, multiplier, 12'605'985'483'714'917'081ULL)
PCG_DEFINE_CONSTANT(uint64_t, mcg, unmultiplier, 15'009'553'638'781'119'849ULL)

PCG_DEFINE_CONSTANT(pcg128_t, mcg, multiplier, PCG_128BIT_CONSTANT(17'766'728'186'571'221'404ULL, 12'605'985'483'714'917'081ULL))
PCG_DEFINE_CONSTANT(pcg128_t, mcg, unmultiplier, PCG_128BIT_CONSTANT(14'422'606'686'972'528'997ULL, 15'009'553'638'781'119'849ULL))
