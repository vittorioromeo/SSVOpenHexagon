...
private:
    ...
    {
        return *pos == '\0' ? hash : fnv((hash * IntType(16'777'619U)) ^ *pos, (pos + 1));
    }

public:
    static constexpr IntType value = fnv(IntType(2'166'136'261U ^ sizeof(IntType)), __DATE__ __TIME__ __FILE__);
};
