...
function copyTo
{
    ...
    cp ./_deps/sfml-build/lib/sfml-graphics-d-3.dll $1 &
    cp ./_deps/sfml-build/lib/sfml-system-d-3.dll $1 &
    cp ./_deps/sfml-build/lib/sfml-window-d-3.dll $1 &
    cp ./_deps/sfml-build/lib/sfml-network-d-3.dll $1 &
    cp ./_deps/sfml-build/lib/sfml-audio-d-3.dll $1 &
