...
namespace hg
{
    namespace Config
    {
        ...
        void setCurrentResolution(ssvs::GameWindow& mWindow,
            unsigned int mWidth, unsigned int mHeight);
        ...
        void setAntialiasingLevel(
            ssvs::GameWindow& mWindow, unsigned int mValue);
