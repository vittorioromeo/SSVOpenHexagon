...
namespace Online
{
    ...
    public:
        ...
        inline void setEmail(const std::string& mUsername, std::string mEmail)
        {
    ...
    public:
        ...
        inline void addLevel(const std::string& mId, const LevelScoreDB& mDB)
        {
            levels[mId] = mDB;
        }
...
{
    ssvuj::convertObj(
    mObj, "ph", mValue.passwordHash, "em", mValue.email, "st", mValue.stats);
}
SSVUJ_CNV_SIMPLE_END();
template <>
...
namespace Online
{
    ...
    public:
        ...
        inline void acceptLogin(unsigned int mUid, const std::string& mUsername)
        {
        ...
        OHServer()
        {
            ...
            ClientHandler& mMS, sf::Packet& mP)
            {
                ...
                if(loginDB.isLoggedIn(username)) {
                    ...
                    mMS.send(buildCPacket<FromServer::LoginResponseInvalid>());
                    return;
                }
            ...
            ClientHandler& mMS, sf::Packet& mP)
            {
                ...
                if(!loginDB.isLoggedIn(username)) {
                    mMS.send(
                    buildCPacket<FromServer::SendScoreResponseInvalid>());
                    return;
                }
            ...
            ClientHandler& mMS, sf::Packet& mP)
            {
                ...
                if(!loginDB.isLoggedIn(username)) {
                    ...
                    mMS.send(buildCPacket<FromServer::SendLeaderboardFailed>());
                    return;
                }
