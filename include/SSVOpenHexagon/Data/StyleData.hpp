...
namespace hg
{
    ...
    private:
        struct ColorData
        {
            ...
            inline ColorData(const ssvuj::Obj& mRoot)
                : main{ssvuj::getExtr<bool>(mRoot, "main", false)},
                  ...
                  color{ssvuj::getExtr<sf::Color>(
                      mRoot, "value", sf::Color::White)},
                  pulse{ssvuj::getExtr<sf::Color>(
                      mRoot, "pulse", sf::Color::White)}
            {
            }
        };
    ...
    public:
        ...
        float maxSwapTime, _3dDepth, _3dSkew, _3dSpacing, _3dDarkenMult,
            _3dAlphaMult, _3dAlphaFalloff, _3dPulseMax, _3dPulseMin,
            _3dPulseSpeed, _3dPerspectiveMult;
        ...
        StyleData(const ssvuj::Obj& mRoot, const Path& mPath)
            : rootPath{mPath},
              ...
              pulseIncrement{
                  ssvuj::getExtr<float>(mRoot, "pulse_increment", 0.f)},
              ...
              _3dPulseSpeed{
                  ssvuj::getExtr<float>(mRoot, "3D_pulse_speed", 0.01f)},
              _3dPerspectiveMult{ssvuj::getExtr<float>(
                  mRoot, "3D_perspective_multiplier", 1.f)},
        ...
        inline const sf::Color& getMainColor() const
        {
            return currentMainColor;
        }
        inline const std::vector<sf::Color>& getColors() const
        {
        ...
        inline const sf::Color& get3DOverrideColor() const
        {
