...
namespace hg
{
    ...
    public:
        ...
        std::string id{packPath.getStr() +
                       ssvuj::getExtr<std::string>(root, "id", "nullId")};
        ...
        Path luaScriptPath{packPath + ssvuj::getExtr<std::string>(
                                          root, "luaFile", "nullLuaPath")};
    ...
    struct LevelStatus
    {
        ...
        inline bool shouldIncrement() const noexcept
        {
