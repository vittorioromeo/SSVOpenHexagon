...
{
#define SSVS_INS_KEY(name) {SSVS_KEY_PREFIX #name, sf::Keyboard::Key::name}
    static std::map<std::string, sf::Keyboard::Key> keys{SSVS_INS_KEY(A), SSVS_INS_KEY(B),
...
{
#define SSVS_INS_KEY(name) {SSVS_KEY_PREFIX #name, sf::Keyboard::Key::name}
    static std::map<std::string, sf::Keyboard::Key> keys{SSVS_INS_KEY(J), SSVS_INS_KEY(K),
...
{
#define SSVS_INS_BTN(name) {SSVS_BTN_PREFIX #name, sf::Mouse::Button::name}
...
inline auto& add2StateInput(GameState& gameState, const ITrigger& on, bool& value,
    const int triggerID, const IType type = IType::Always,
