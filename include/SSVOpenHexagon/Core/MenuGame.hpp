...
namespace hg
{
	...
	class MenuGame
	{
		private:
			...
			inline sf::Text& renderTextImpl(const std::string& mStr, sf::Text& mText, const Vec2f& mPosition)
			{
			...
			inline sf::Text& renderText(const std::string& mStr, sf::Text& mText, const Vec2f& mPos, float mSize)							{ mText.setColor(getTextColor()); return renderTextImpl(mStr, mText, mPos, mSize); }
			inline sf::Text& renderText(const std::string& mStr, sf::Text& mText, const Vec2f& mPos, const sf::Color& mColor)				{ mText.setColor(mColor); return renderTextImpl(mStr, mText, mPos); }
			inline sf::Text& renderText(const std::string& mStr, sf::Text& mText, const Vec2f& mPos, const sf::Color& mColor, float mSize)	{ mText.setColor(mColor); return renderTextImpl(mStr, mText, mPos, mSize); }
