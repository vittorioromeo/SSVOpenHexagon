...
/// @param mObj Parent Obj.
/// @param mKey Key of the child Obj to convert.
/// @param mDefault Default value to use, in case the Obj hasn't got the desired
/// value.
template <typename T>
...
/// @brief Returns a new JSON array instance with any number of values archived
/// in it.
/// @param mArgs Const references to the values to archive.
template <typename... TArgs>
...
/// @param mArgs For every value extracted, pass a key and a reference to the
/// value.
template <typename... TArgs>
...
/// @param mArgs For every value archived, pass a key and a const reference to
/// the value.
template <typename... TArgs>
...
/// @brief Returns a new JSON Obj instance with any number of values archived in
/// it.
/// @param mArgs For every value archived, pass a key and a const reference to
/// the value.
template <typename... TArgs>
...
/// @brief Archives/extracts a value into/from a JSON Obj, depending from the
/// constness.
